...
export function SettingsManagementView({ onNavigateTab }: SettingsSectionProps = {}) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-card">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                <Settings size={20} className="text-emerald-800 shrink-0" />
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              <Save size={16} className="text-emerald-200 shrink-0" />
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                    <Sliders size={20} className="text-emerald-800 shrink-0" />
            ...
            <div className="p-5 bg-gradient-to-r from-emerald-50/70 to-slate-50 rounded-2xl border border-emerald-200 space-y-3">
              <div className="flex items-center justify-between">
                <h4 className="text-xs font-bold text-emerald-950 flex items-center gap-2">
                  <Sliders size={16} className="text-emerald-800 shrink-0" />
        ...
        <div className="space-y-6 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-card space-y-6">
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                  <CreditCard size={20} className="text-emerald-800 shrink-0" />
      ...
      {/* ========================================================================= */}
      {/* TAB 3: GATEWAY NOTIFIKASI & WHATSAPP                                      */}
      {/* ========================================================================= */}
      {activeTab === 'notifications' && (
        <div className="space-y-6 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-card space-y-6">
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                  <Bell size={20} className="text-emerald-800 shrink-0" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                <label className="font-bold text-slate-800 flex items-center gap-1.5">
                  <Key size={16} className="text-emerald-700 shrink-0" />
                ...
                <div className="relative">
                  ...
                  >
                    {showApiKey ? <EyeOff size={16} className="shrink-0" /> : <Eye size={16} className="shrink-0" />}
                  </button>
                </div>
              </div>
            </div>
