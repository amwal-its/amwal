        ...
        // ── PENGAWASAN PROGRAM ─────────────────────────────
        {
          ...
          children: [
            ...
            },
            {
              ...
              // Distinct from /admin/approvals (Pusat Persetujuan level-1) to avoid double-active
              href: '/admin/approvals?tab=kuitansi',
              icon: Receipt,
              exactMatch: true,
            },
          ],
          ...
          children: [
            {
              ...
              href: '/admin/transparansi?filter=INFAQ',
              icon: HeartHandshake,
              exactMatch: true,
            },
            {
              ...
              href: '/admin/transparansi?filter=ZAKAT',
              icon: Coins,
              exactMatch: true,
            },
            {
